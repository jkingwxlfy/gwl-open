...
export const metadata: Metadata = {
    ...
    Наши услуги очень финансово выгодны, ведь они дешевле, чем оклад среднего штатного логиста, а наша команда — это высококвалифицированные знатоки внешнеэкономического права.`,
}
