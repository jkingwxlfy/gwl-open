...
export const metadata: Metadata = {
    ...
    description:
        'Школа Таможенного Брокера в Алматы от лучших специалистов компании. Участники изучают правила и нормы в области международной торговли, учатся заполнять документы и эффективно взаимодействовать с контролирующими органами. Программа курса позволяет самостоятельно осуществлять процесс оформления грузов, ускорять его, корректно декларировать стоимость товаров и их классификационные коды, а также точно рассчитывать налоги и сборы. По окончании обучения участники получают сертификат. Курс проходит в Алматы',
}
