                ...
                <>
                    ...
                    <div className='about-page__exp-info1'>
                        <div className='about-page__exp-info1__text'>
                            ...
                            чтобы помочь вам преодолеть любые вызовы и
                    ...
                    <div className='about-page__exp-info2__text'>
                        ...
                        внешнеэкономического регулирования. <br /> <br /> Мы
                        ценим каждого клиента и гарантируем индивидуальный
                    ...
                    <div className='about-page__exp-info3__text'>
                        ...
                        внешнеэкономической деятельности и обеспечить вашему
                        бизнесу успешное развитие на мировом рынке. Вместе с{' '}
                ...
                <>
                    ...
                    <div className='about-page__exp-info3'>
                        <div className='about-page__exp-info3__text'>
                            ...
                            вопросах внешнеэкономической деятельности и
                            обеспечить вашему бизнесу успешное развитие на
                            мировом рынке. Вместе с <span>GWL Group</span> вы
                            можете быть уверены в профессиональном подходе и
                            надежной поддержке на каждом этапе вашего пути.
                        </div>
                        <Image
                            className='about-page__exp-info3__image'
                            src={exp3}
