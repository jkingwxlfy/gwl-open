                ...
                <>
                    <div className='about-page__opp-text'>
                        ...
                        <div className='about-page__opp-text__content'>
                            ...
                            вопросов на таможне и в банке.
                        </div>
                    </div>
                    <div className='about-page__opp-text-right'>
                        <div className='about-page__opp-text__pointer-right' />
                        <div className='about-page__opp-text__content'>
                            Корректно оформим <span>таможенную декларацию</span>{' '}
                            на ваш товар. Мы экономим Ваше время и средства,
                            избавляя от необходимости покупать дорогостоящее
                            программное обеспечение для оформления таможенных
                            деклараций, а также от необходимости вникать во все
                    ...
                    <div className='about-page__opp-text-right'>
                        ...
                        <div className='about-page__opp-text__content'>
                            ...
                            проблемы с таможенными органами в процессе
